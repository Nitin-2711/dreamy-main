          ...
          >
            <div className="w-full h-full rounded-xl overflow-hidden relative">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-left z-20">
                <h4 className="font-heading text-xl md:text-2xl text-theme-text mt-1">Galaxy Blue Sapphire Plaza</h4>
                <p className="text-sm text-theme-text-secondary mt-2 max-w-2xl leading-relaxed">
